...
for word in fileinfo:
    ...
    file_jaccard_1="./WQY/"+word+"/"+word+"_1_jaccard.txt"
    file_nbld_1="./WQY/"+word+"/"+word+"_1_nbld.txt"
    file_jaccard_2="./WQY/"+word+"/"+word+"_2_jaccard.txt"
    file_nbld_2="./WQY/"+word+"/"+word+"_2_nbld.txt"
    file_corr="./WQY/"+word+"/"+word+"_corr.txt"
