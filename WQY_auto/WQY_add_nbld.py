...
word=sys.argv[1] if len(sys.argv)>=2 else input("add_nbld: input a word:")
...
#print("add_nbld: Reading adjacency data completed!")

data_out={}

#print("add_nbld: Reading wiki_out data...")
...
f.close()
#print("add_nbld: Reading wiki_out data completed!")
...
#print("add_nbld: Reading wiki_in data...")
...
f.close()
#print("add_nbld: Reading wiki_in data completed!")
...
print("add_nbld: Process completed!")
sys.exit()
