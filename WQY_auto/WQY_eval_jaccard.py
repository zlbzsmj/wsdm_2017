...
if os.path.exists("./eval_jaccard.csv"):os.remove("./eval_jaccard.csv")
...
for dirname in fileinfo:
    ...
    file_corr="./WQY_rational/"+dirname+"/"+"2_jaccard.txt"
    file_cs="./WQY_rational/"+dirname+"/"+"2_total_clickstream.txt"
    ...
    f=open("./eval_jaccard.csv","a",encoding="utf-8")
