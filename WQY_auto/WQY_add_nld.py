...
#print("add_nld: Reading wiki_in data...")
...
f.close()
#print("add_nld: Reading wiki_in data completed!")

datalen=len(data_in)

word=sys.argv[1] if len(sys.argv)>=2 else input("add_nld: input a word:")
...
print("add_nld: Process completed!")
sys.exit()
